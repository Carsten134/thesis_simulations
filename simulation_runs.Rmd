...
mc_row_col_alt <- future_mc(row_col_alt,
                            ...
                            param_list_alt)
# save result
write.csv(mc_row_col_alt$output,r"{D:\Daten\DataScienceMaster\Semester 4\Masterarbeit\plotting_simulation_results\sim_results\power\mc_row_col_alt.csv}")
```
...
param_list_null <- list(n=c(3, 5, 7, 11),
                        alpha=c(.1, .05, .01))
